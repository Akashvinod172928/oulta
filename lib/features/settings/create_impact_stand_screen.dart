...
class CreateImpactStandScreen extends StatelessWidget {
  const CreateImpactStandScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    // Structured Who Should Act list
    final RxList<Map<String, String>> whoShouldActList =
    ...
    final RxString selectedType = 'Education'.obs;
    ...
    final RxBool isPetition = false.obs;
              ...
              child: ElevatedButton(
                onPressed: () {
                  if (nameController.text.trim().isNotEmpty) {
                    socialController.addImpactStand(
                      nameController.text.trim(),
                      selectedCommunity.value,
                      subHeadingController.text.trim(),
                      descriptionController.text.trim(),
                      selectedType.value,
                      whoShouldActList.toList(),
                      imageFiles.toList(),
                      isPetition.value,
                    );
                  } else {
